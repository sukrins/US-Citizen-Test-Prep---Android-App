 ...
 */
public class CivicResult extends Activity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.civic_result);
        RatingBar bar = (RatingBar) findViewById(R.id.civicRatingBar);
        bar.setNumStars(5);
        bar.setStepSize(0.01f);

        TextView text = (TextView) findViewById(R.id.civicTextResult);
        ImageView image = (ImageView) findViewById(R.id.civicImageResult);
